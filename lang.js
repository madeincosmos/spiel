...
let text = {
    "de": {
        ...
        "rules": [
            "Wenn eine lebendige Zelle 2 oder 3 lebendige Nachbarszellen hat, bleibt sie in der nächsten Runde aktiviert.",
            "Wenn eine lebendige Zelle weniger als 2 oder mehr als 3 aktive Nachbarszellen hat, stirbt sie in der nächsten Runde.",
            "Wenn eine tote Zelle genau drei lebendige Nachbarszellen hat, wird sie in der nächsten Runde wieder aktiviert."
        ],
    ...
    "fr": {
        ...
        "rules": [
            "Si une cellule vivante est entourée par 2 ou 3 cellules vivantes, elle reste en vie à la génération suivante.",
            "Si une cellule vivante est entourée par moins de 2 cellules vivantes, elle meurt à la génération suivante.",
            "Si une cellule morte se retrouve entourée par exactement 3 cellules vivantes, elle renaît à la génération suivante."
        ],
